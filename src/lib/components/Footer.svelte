...
<footer class="site-footer">
  <div class="footer-inner">
    ...
    <div class="footer-social">
      <a
        href="https://github.com/navadeepnaidu7"
        target="_blank"
      ...
      <a
        href="https://x.com/navadeep_naidu7"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Twitter"
      >
      ...
      <a
        href="https://medium.com/@navadeepnaidu7"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Medium"
      >
      ...
      <button class="rss-btn" onclick={handleRssClick} aria-label="RSS Feed">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
...
{#if showRssToast}
  <div class="rss-toast">
    ...
    <span>RSS URL copied to clipboard</span>
  </div>
{/if}
